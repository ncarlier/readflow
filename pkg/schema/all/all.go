...
import (
	...
	_ "github.com/ncarlier/readflow/pkg/schema/device"
	// activate incoming webhook schema
	_ "github.com/ncarlier/readflow/pkg/schema/incoming-webhook"
	// activate outgoing webhook schema
	_ "github.com/ncarlier/readflow/pkg/schema/outgoing-webhook"
	// activate plan schema
	_ "github.com/ncarlier/readflow/pkg/schema/plan"
	// activate user schema
	_ "github.com/ncarlier/readflow/pkg/schema/user"
)
